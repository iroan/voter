 ...
 */
export declare type VoterParams = object;
...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
     ...
     * @request GET:/iroan/voter/voter/params
     */
    queryParams: (params?: RequestParams) => Promise<HttpResponse<VoterQueryParamsResponse, RpcStatus>>;
    /**
     * No description
     *
     * @tags Query
     ...
     * @request GET:/iroan/voter/voter/poll
     */
    queryPollAll: (query?: {
     ...
     * @request GET:/iroan/voter/voter/poll/{id}
     */
